...
class _StudentProgressScreenState extends State<StudentProgressScreen> {
  ...
  Widget build(BuildContext context) {
    debugPrint('Building StudentProgressScreen: _isLoading=$_isLoading, _userRole=$_userRole');
    return Scaffold(
                    ...
                    children: [
                      ...
                      if (_progress.isEmpty)
                        ...
                        ..._progress.map((p) {
                          ...
                          final title = experimentId?['title'] ?? 'Unknown Experiment';
                          final totalSteps = experimentId?['steps']?.length ?? 0;
                          final completedSteps = p['completedSteps']?.length ?? 0;
                          final progressFraction = totalSteps > 0 ? completedSteps / totalSteps : 0.0;
                          ...
                          return Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(20),
                              border: Border.all(
                                color: isCompleted ? _primaryColor : _primaryColor.withOpacity(0.2),
